...
<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
    ...
    <form action="index.php?controller" method="post" class="mt-2">
        ...
        ?>
        <textarea name="message" id="myTextArea" class="col-12 form-control message" placeholder="Your plaintext or cipher here..." maxlength="300"><?php echo $message ?></textarea>
        ...
        ?>
        <input type="number" name="shift" title="Leave empty for all possible ciphers" class="col-xs-6 col-sm-6 col-md-3 col-lg-2 form-control mt-2 shift" placeholder="Shift" min="0" max="25" step="1" value='<?php echo $shift ?>'>
